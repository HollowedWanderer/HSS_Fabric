...
public class FrozenGaleFeatureRenderer<T extends LivingEntity> extends FeatureRenderer<T, PlayerEntityModel<T>> {
	...
	public FrozenGaleFeatureRenderer(FeatureRendererContext<T, PlayerEntityModel<T>> context, EntityModelLoader loader) {
		super(context);
	...
	public void render(
		...
		if (ModComponents.FROZEN_GALING.get(livingEntity).getValue()) {
