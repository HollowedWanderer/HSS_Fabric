...
public class ThaumiteScreenShake extends MovingSoundInstance {
    private final ResonatingAltarBlockEntity projectile;

    public ThaumiteScreenShake(ResonatingAltarBlockEntity projectile) {
        super(ModSounds.THAUMITE_SCREENSHAKE, SoundCategory.PLAYERS, SoundInstance.createRandom());
